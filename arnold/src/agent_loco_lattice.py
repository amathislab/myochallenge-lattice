...
# EXPERIMENT_PATH = os.path.join(ROOT_DIR, "output/training/2023-09-29/CustomChaseTag_seed_8_x_-5.0_5.0_y_-5.0_5.0_dist_2.0_hip_0.5_period_100.0_alive_0.0_solved_0.0_early_solved_300.0_joints_2.0_lose_-1000.0_ref_1.0_heel_0.0_gait_l_0.8_gait_c_1.0_fix_0.1_ran_0.45_mov_0.45_job_64")
# CHECKPOINT_NUM = 351977472

# EXPERIMENT_PATH = os.path.join(ROOT_DIR, "output/training/2023-11-04/CustomChaseTag_seed_15_x_-5.5_5.5_y_-5.5_5.5_dist_0.001_hip_0.0_period_100.0_alive_0.0_solved_1000.0_early_solved_0.0_joints_0.0_lose_-10.0_ref_0.01_heel_0.0_gait_l_0.9_gait_c_0.01_fix_0.1_ran_0.45_mov_0.45_traj_virtual_trajmyo-train-ad-p2-7-2")
...
if __name__ == "__main__":
    ...
    while not flag_completed:
        ...
        while not flag_trial :
            ...
            obs = get_custom_observation(rc, virtual_traj=virtual_traj)
            task = obs[-1]
            obs = obs[:-1]

...
parser.add_argument("--x_min_obj_xyz_range", type=float, default=-0.1)
parser.add_argument("--y_min_obj_xyz_range", type=float, default=-0.35)
parser.add_argument("--z_min_obj_xyz_range", type=float, default=1.0)

parser.add_argument("--x_max_obj_xyz_range", type=float, default=0.1)
parser.add_argument("--y_max_obj_xyz_range", type=float, default=-0.15)
parser.add_argument("--z_max_obj_xyz_range", type=float, default=1.0)

parser.add_argument("--x_min_obj_geom_range", type=float, default=0.015)
parser.add_argument("--y_min_obj_geom_range", type=float, default=0.015)
parser.add_argument("--z_min_obj_geom_range", type=float, default=0.015)

parser.add_argument("--x_max_obj_geom_range", type=float, default=0.025)
parser.add_argument("--y_max_obj_geom_range", type=float, default=0.025)
parser.add_argument("--z_max_obj_geom_range", type=float, default=0.025)

parser.add_argument("--min_obj_mass_range", type=float, default=0.050)
parser.add_argument("--max_obj_mass_range", type=float, default=0.200)

parser.add_argument("--x_min_obj_friction_range", type=float, default=0.8)
parser.add_argument("--y_min_obj_friction_range", type=float, default=0.004)
parser.add_argument("--z_min_obj_friction_range", type=float, default=0.00008)

parser.add_argument("--x_max_obj_friction_range", type=float, default=1.2)
parser.add_argument("--y_max_obj_friction_range", type=float, default=0.006)
parser.add_argument("--z_max_obj_friction_range", type=float, default=0.00012)
...
env_config = {
    ...
    'obj_xyz_range': {'high':[args.x_max_obj_xyz_range, args.y_max_obj_xyz_range, args.z_max_obj_xyz_range], 'low':[args.x_min_obj_xyz_range, args.y_min_obj_xyz_range, args.z_min_obj_xyz_range]},
    'obj_geom_range': {'high':[args.x_max_obj_geom_range, args.y_max_obj_geom_range, args.z_max_obj_geom_range], 'low':[args.x_min_obj_geom_range, args.y_min_obj_geom_range, args.z_min_obj_geom_range]},
    'obj_mass_range': {'high':args.max_obj_mass_range, 'low':args.min_obj_mass_range},# 50gms to 200 gms
    'obj_friction_range': {'high':[args.x_max_obj_friction_range, args.y_max_obj_friction_range, args.z_max_obj_friction_range], 'low':[args.x_min_obj_friction_range, args.y_min_obj_friction_range, args.z_min_obj_friction_range]}
}
